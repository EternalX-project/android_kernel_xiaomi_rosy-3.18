...
static uint16_t eeprom_sensor_readreg(struct msm_eeprom_ctrl_t *s_ctrl,
				      uint32_t reg_addr)
{
...
static int eeprom_sensor_writereg(struct msm_eeprom_ctrl_t *s_ctrl,
...
static int eeprom_init_ov5675_reg_otp(struct msm_eeprom_ctrl_t *e_ctrl,
				      uint16_t addr)
{
	int rc = 0;
...
static uint16_t sensor_eeprom_match_crc_id(struct msm_eeprom_ctrl_t *e_ctrl,
					   uint32_t addr)
{
	uint16_t data = 0;
