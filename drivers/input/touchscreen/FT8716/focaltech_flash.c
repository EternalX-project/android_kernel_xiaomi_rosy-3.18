...
u8 fw_upgrade_status = FW_NO_UPGRADE;
...
u8 CTPM_FW[] =
{
#include FTS_UPGRADE_FW_APP_EBBG
};

u8 CTPM_FW1[] =
{
#include FTS_UPGRADE_FW_APP_CSOT
};
...
static int fts_ctpm_check_fw_status(struct i2c_client *client)
{
    ...
    for (i = 0; i < 5; i++)
    {
        ...
        if (((chip_id1 == chip_types.chip_idh) || (chip_id1 == 87))
#if FTS_CHIP_IDC
            && ((chip_id2 == chip_types.chip_idl) || (chip_id2 == 16))
#endif
           )
        {
...
int fts_ctpm_auto_upgrade(struct i2c_client *client)
{
    ...
    {
        /* FW Upgrade */
	fw_upgrade_status = FW_UPGRADING;
        do
        {
            uc_upgrade_times++;
