...
MMC_DEV_ATTR(fw_version, "0x%02x%02x%02x%02x%02x%02x%02x%02x\n",
		card->ext_csd.fw_reg[7], card->ext_csd.fw_reg[6],
		card->ext_csd.fw_reg[5], card->ext_csd.fw_reg[4],
		card->ext_csd.fw_reg[3], card->ext_csd.fw_reg[2],
		card->ext_csd.fw_reg[1], card->ext_csd.fw_reg[0]);
